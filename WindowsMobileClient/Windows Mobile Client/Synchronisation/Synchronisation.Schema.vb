...
Partial Class Synchronisation
    Private Shared Function UpdateTerminology(ByVal lastSchemaCheck As DateTime) As Boolean
        Try
            ...
            Dim terminologyUpdateDs As LanguageDataSet = gWebServer.GetTerminology(gDeviceIDString, gConsultantUID, Terminology.ClientKey, ConfigurationSettings.GetValue(My.Resources.AppConfigLanguageIdKey, CInt(My.Resources.AppConfigLanguageIdDefault)), lastSchemaCheck.AddDays(-7))
    ...
    Private Shared Function SchemaCheckRequired(ByVal schemaCheckTime As Date, ByVal lastSchemaCheck As Date) As Boolean
        Try
            Dim schemaCheckInterval As Integer = ConfigurationSettings.GetValue(My.Resources.AppConfigSchemaCheckIntervalKey, 1)
    ...
    Friend Shared Function GetSchemaAndTerminologyUpdates(Optional ByVal force As Boolean = False) As Boolean
        ...
        Dim lastSchemaCheck As Date = DateTime.SpecifyKind(ConfigurationSettings.GetValue(My.Resources.AppConfigLastSchemaCheckKey, DateTime.MinValue), DateTimeKind.Utc)
        ...
        Try
            ...
            ConfigurationSettings.SetValue(My.Resources.AppConfigLastSchemaCheckKey, schemaCheckTime)
