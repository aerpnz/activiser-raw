...
Public Class MainForm
    ...
    Public Sub InitializeRequestList()
        ...
        Try
            ...
            Try
                Dim columnWidths() As String = AppConfig.GetSetting(My.Resources.AppConfigMainFormColumnWidthsKey, "").Split(","c)
            ...
            Me._sortColumnIndex = AppConfig.GetSetting(My.Resources.AppConfigMainFormSortColumnKey, 0)
            Dim header As SortableColumnHeader = CType(RequestList.Columns(Me._sortColumnIndex), SortableColumnHeader)
            header.Ascending = AppConfig.GetSetting(My.Resources.AppConfigMainFormSortAscendingKey, True)
        Catch ex As Exception
...
#Region "Custom Request Status Menu Items"
    ...
    Private Sub ViewStatusSpecific_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormStatusFilterKey, statusIdFilter)
        Me.PopulateRequestList()
    End Sub
...
#End Region
    ...
    Private Sub Form_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If AppConfig.GetSetting("Hopper", False) Then
...
#End If
            ...
            Try
                Me.RequestDetails.Height = AppConfig.GetSetting(My.Resources.AppConfigMainFormRequestDescriptionHeightKey, 60)
            Catch
                ' ignore errors here..
            End Try
...
#End Region
    ...
    Private Sub backgroundLoader()
        ...
        Try
            ...
            _useLastModifiedTimeForNullActionDates = AppConfig.GetSetting(My.Resources.AppConfigMainFormUseLastModifiedForNullActionDatesKey, False)
            _showTimeInDateColumn = AppConfig.GetSetting(My.Resources.AppConfigMainFormShowTimeInDateColumnKey, False)
            _showRequestedStatus = AppConfig.GetSetting(My.Resources.AppConfigMainFormShowRequestedStatusKey, True)
            _showToolBar = AppConfig.GetSetting(My.Resources.AppConfigMainFormShowToolBarKey, True)
            _toolBarSize = AppConfig.GetSetting(My.Resources.AppConfigMainFormToolBarSizeKey, CInt(RunTimeScale * 2))
            _showToolBarCaptions = AppConfig.GetSetting(My.Resources.AppConfigMainFormShowToolBarCaptionsKey, False)
            _showRequestListCheckboxes = AppConfig.GetSetting(My.Resources.AppConfigMainFormShowCheckBoxesKey, False)
            ...
            SetCheckState(Me.ViewShowColumnHeaders, AppConfig.GetSetting(My.Resources.AppConfigMainFormShowColumnHeadersKey, True))
            SetCheckState(Me.ViewShowSyncInfo, AppConfig.GetSetting(My.Resources.AppConfigMainFormShowSyncInfoKey, True))
            ...
            Me.statusIdFilter = AppConfig.GetSetting(My.Resources.AppConfigMainFormStatusFilterKey, -1)
            For Each miRequest As RequestStatusMenuItem In RequestMenuItemList
                SetCheckState(miRequest.FilterMenuItem, miRequest.RequestStatusID = statusIdFilter)
            Next

            SetCheckState(Me.ViewPersonMe, AppConfig.GetSetting(My.Resources.AppConfigMainFormShowMyRequestsOnlyKey, True))
...
#End Region
    ...
    Private Sub SaveDisplaySettings()
        ...
        Next
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormColumnWidthsKey, columnWidths.ToString)
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormRequestDescriptionHeightKey, Me.RequestDetails.Height)
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormToolBarSizeKey, _toolBarSize)
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormLastSortColumnKey, _sortColumnIndex)
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormStatusFilterKey, statusIdFilter)
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowMyRequestsOnlyKey, ViewPersonMe.Checked)
        AppConfig.Save()
    End Sub
    ...
    Private Sub MenuViewToolbar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewMenuToolbarOff.Click, ViewMenuToolbarSmall.Click, ViewMenuToolbarMedium.Click, ViewMenuToolbarLarge.Click, ViewMenuToolbarSmaller.Click, ViewMenuToolbarLarger.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowToolBarKey, _showToolBar)
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormToolBarSizeKey, _toolBarSize)
        SetToolBarView()
    End Sub
    ...
    Private Sub SetToolBarView()
        ...
        Else
            Try
                ...
                Dim buttonFontSize As Single = AppConfig.GetSetting(My.Resources.AppConfigTextSizeKey, 8) - 1
    ...
    Public Sub LoadImages()
        ...
        SyncButton.BeginUpdate()
        If MyDpiX > 100 Then
            SyncButton.Image = My.Resources.SyncIcon48
        Else
            SyncButton.Image = My.Resources.SyncIcon24
        End If
        SyncButton.ImageAlignment = ContentAlignment.MiddleRight
        SyncButton.EndUpdate()
    ...
    Private Sub menuShowCheckBoxes_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewShowCheckBoxes.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowCheckBoxesKey, isChecked)
    End Sub
    ...
    Private Sub ViewShowColumnHeaders_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewShowColumnHeaders.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowColumnHeadersKey, isChecked)
    End Sub
    ...
    Private Sub ViewShowSyncInfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewShowSyncInfo.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowSyncInfoKey, isChecked)
    End Sub
    ...
    Private Sub ViewShowTimeInDateColumn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewShowTimeInDateColumn.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowTimeInDateColumnKey, _showTimeInDateColumn)
        Me.PopulateRequestList()
    End Sub
...
#End If
    ...
    Private Sub ViewShowRequestedStatus_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewShowRequestedStatus.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowRequestedStatusKey, _showRequestedStatus)
        Me.InitializeRequestList()
    End Sub
...
#End If
    ...
    Private Sub ViewMenuToolbarShowCaptions_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ViewMenuToolbarShowCaptions.Click
        ...
        AppConfig.SaveSetting(My.Resources.AppConfigMainFormShowToolBarCaptionsKey, _showToolBarCaptions)
        SetToolBarView()
    End Sub
