...
Module RequestUtilities
    ...
    Public Function RequestLocked(ByVal request As RequestRow) As Boolean
        ...
        Return (Not ConfigurationSettings.GetValue(My.Resources.AppConfigAllowJobsForClosedRequestsKey, True)) _
    ...
    Public Function NewJobsAllowed(ByRef request As RequestRow) As Boolean
        ...
        If rs IsNot Nothing Then
            If (rs.IsCancelledStatus OrElse rs.IsCompleteStatus) Then
                If ConfigurationSettings.GetValue(My.Resources.AppConfigAllowJobsForClosedRequestsKey, True) Then
                    Return True
                Else
                    Return False
                End If
