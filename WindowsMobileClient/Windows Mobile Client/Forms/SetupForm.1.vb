...
Public Class SetupForm
    ...
    Private Sub LoadSettings()
        ...
        Me.DeviceIDTextBox.Text = GetFormattedDeviceID(gDeviceID)
        ...
        Me.IgnoreCertificateErrorsCheckbox.Checked = AppConfig.GetSetting("IgnoreServerCertificateErrors", False)
        ...
        Me.UseIntegratedAuthentication = AppConfig.GetSetting(My.Resources.AppConfigUseIntegratedAuthenticationKey, String.IsNullOrEmpty(gUsername)) ' AndAlso String.IsNullOrEmpty(gPassword)
    ...
    Private Function Save() As Boolean
        ...
        Try
            ...
            gServerUrl = Me.Url
            AppConfig.SaveSetting(My.Resources.AppConfigServerUrlKey, Me.ServerUrlTextBox.Text)
            ...
            Try
                ...
                AppConfig.SaveSetting(My.Resources.AppConfigServerTimeoutKey, gWebServiceTimeout)
                gWebServiceTimeout *= 1000
            Catch ex As FormatException
                AppConfig.SaveSetting(My.Resources.AppConfigServerTimeoutKey, 120)
            End Try

            AppConfig.SaveSetting(My.Resources.AppConfigIgnoreServerCertificateErrorsKey, Me.IgnoreCertificateErrors)
            ...
            AppConfig.SaveSetting(My.Resources.AppConfigUseIntegratedAuthenticationKey, Me.UseIntegratedAuthentication)
