...
Public Class CustomFormPanel
    ...
    Private fontSize As Integer = ConfigurationSettings.GetValue(My.Resources.AppConfigTextSizeKey, 8)
    ...
    Private _maxChildren As Integer = ConfigurationSettings.GetValue("MaximumCustomRecordsPerParent", 20)
