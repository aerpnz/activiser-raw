...
namespace activiser.WebService.OutputGateway.EventLogTableAdapters {
    ...
    public partial class EventLogTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [logging].[CrmGatewayEventLog] WHERE (([EventId] = @Original_EventId)" +
                ")";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [logging].[CrmGatewayEventLog] ([EventId], [EventDateTime], [Message]" +
                ", [Data]) VALUES (@EventId, @EventDateTime, @Message, @Data)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [logging].[CrmGatewayEventLog] SET [EventId] = @EventId, [EventDateTime] =" +
                " @EventDateTime, [Message] = @Message, [Data] = @Data WHERE (([EventId] = @Origi" +
                "nal_EventId))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::activiser.WebService.OutputGateway.Properties.Settings.Default.activiserConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT     EventId, EventDateTime, Message, Data\r\nFROM         logging.CrmGateway" +
                "EventLog";
        ...
        public virtual int Delete(System.Guid Original_EventId) {
        ...
        public virtual int Insert(System.Guid EventId, System.DateTime EventDateTime, string Message, object Data) {
        ...
        public virtual int Update(System.Guid EventId, System.DateTime EventDateTime, string Message, object Data, System.Guid Original_EventId) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((System.Guid)(Original_EventId));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime EventDateTime, string Message, object Data, System.Guid Original_EventId) {
            return this.Update(Original_EventId, EventDateTime, Message, Data, Original_EventId);
        }
    }
