...
Public Class BusinessObjectCollection
    ...
    Public Shared Sub PopulateList(ByVal listBox As ComboBox, ByVal list As BusinessObjectCollection, ByVal tableName As String, ByVal idColumnName As String, ByVal descriptionColumnName As String, ByVal filter As String, ByVal nullValue As Nullable(Of Guid), ByVal nullDescription As String)
        Try
            Trace.Indent()
            TraceVerbose(STR_Fired)
            ...
            Using newList As New BusinessObjectCollection()
                ...
                If Not String.IsNullOrEmpty(nullDescription) Then
                    Dim nullItem As activiser.Console.BusinessObjectListItem = New BusinessObjectListItem(nullValue, nullDescription)
                    list.Add(nullItem)
                End If

                'Dim newRows() As System.Data.DataRow = table.Select(filter, descriptionColumnName)
                'For Each dr As DataRow In newRows
                '    newList.Add(New BusinessObjectListItem(CType(dr(idColumnName), Guid), CStr(dr(descriptionColumnName))))
                'Next

                'Dim nukelist As New List(Of Integer)
                'For e As Integer = 0 To list.Count - 1
                '    Dim found As Boolean = False
                '    For n As Integer = 0 To newList.Count - 1
                '        If list.Item(e) = newList.Item(n) Then
                '            found = True
                '            Exit For
                '        End If
                '    Next
                ...
                'If Not String.IsNullOrEmpty(nullDescription) Then
                '    For e As Integer = 0 To list.Count - 1
                '        If list.Item(e).Description = nullDescription Then
                '            nukelist.Add(e)
                '        End If
                '    Next
                'End If
                ...
                'nukelist.Sort()
                'nukelist.Reverse()
                'For Each e As Integer In nukelist
                '    list.RemoveItem(e)
                'Next
                'nukelist = Nothing
                ...
                '    Next
                '    If Not found Then
                '        list.Add(newList.Item(n))
                '    End If
                'Next

                'If Not String.IsNullOrEmpty(nullDescription) Then
                '    Dim nullItem As activiser.Console.BusinessObjectListItem = New BusinessObjectListItem(nullValue, nullDescription)
                '    newList.Add(nullItem)
                'End If
    ...
    Public Shared Sub PopulateList(ByVal listBox As ComboBox, ByVal list As BusinessObjectCollection, ByVal tableName As String, ByVal idColumnName As String, ByVal descriptionColumnName As String, ByVal filter As String)
        PopulateList(listBox, list, tableName, idColumnName, descriptionColumnName, filter, Nothing, Nothing)
    End Sub

    Public Shared Sub PopulateList(ByVal listBox As ComboBox, ByVal list As BusinessObjectCollection, ByVal tableName As String, ByVal idColumnName As String, ByVal descriptionColumnName As String)
        PopulateList(listBox, list, tableName, idColumnName, descriptionColumnName, String.Empty, Nothing, Nothing)
    End Sub

    Public Shared Sub PopulateList(ByVal listBox As DataGridViewComboBoxColumn, ByVal list As BusinessObjectCollection, ByVal tableName As String, ByVal idColumnName As String, ByVal descriptionColumnName As String, ByVal filter As String, ByVal nullValue As Nullable(Of Guid), ByVal nullDescription As String)
        Try
            Trace.Indent()
            TraceVerbose(STR_Fired)
    ...
    Public Shared Sub PopulateList(ByVal listBox As DataGridViewComboBoxColumn, ByVal list As BusinessObjectCollection, ByVal tableName As String, ByVal idColumnName As String, ByVal descriptionColumnName As String, ByVal filter As String)
        PopulateList(listBox, list, tableName, idColumnName, descriptionColumnName, filter, Nothing, Nothing)
    End Sub

    Public Shared Sub PopulateList(ByVal listBox As DataGridViewComboBoxColumn, ByVal list As BusinessObjectCollection, ByVal tableName As String, ByVal idColumnName As String, ByVal descriptionColumnName As String)
        PopulateList(listBox, list, tableName, idColumnName, descriptionColumnName, String.Empty, Nothing, Nothing)
    End Sub
