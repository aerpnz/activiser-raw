...
Partial Friend Class Synchronisation
    ...
    Private Shared Function UseCompression() As Boolean
        Return ConfigurationSettings.GetValue(My.Resources.AppConfigUseCompressionKey, True)
    End Function
    ...
    Friend Shared Function SyncFull() As Boolean
        ...
        Try
            ...
            'If Serialisation.SaveInProgress(gClientDataSet) Then
        ...
        Finally
            ...
            Try
                ...
                If Not String.IsNullOrEmpty(ConfigurationSettings.GetValue(My.Resources.AppConfigForceLastSyncDateTimeKey, String.Empty)) Then
                    ConfigurationSettings.SetValue(My.Resources.AppConfigForceLastSyncDateTimeKey, String.Empty)
                End If
            ...
            If ConfigurationSettings.GetValue("PlaySyncCompleteSound", True) Then
    ...
    Friend Shared Function DownloadChanges() As DataSet
        ...
        Try
            ...
            Else
                Dim updatesXml As System.Xml.XmlNode = gWebServer.GetClientDataSetUpdatesAsXml(gDeviceIDString, gConsultantUID.ToString(), ConsultantConfig.LastSync)
    ...
    Private Shared Sub ReloadLookups(ByVal mergedDataSet As activiserDataSet)
        If ConfigurationSettings.GetValue(My.Resources.AppConfigFlushCustomLookupsKey, False) Then
            ' TODO:
        End If
    End Sub
    ...
    Private Shared Sub CheckSyncFrequency()
        ...
        ConfigurationSettings.SetValue(My.Resources.AppConfigSyncIntervalKey, requiredSyncInterval)
