    ...
    public class GpsClient
    {
        ...
        public void Open()
        {
            if (!Opened)
            {
                ...
                newPositionHandle = CreateEvent(IntPtr.Zero, 0, 0, null);
                deviceStateChangedHandle = CreateEvent(IntPtr.Zero, 0, 0, null);
                stopHandle = CreateEvent(IntPtr.Zero, 0, 0, null);

                gpsHandle = GPSOpenDevice(newPositionHandle, deviceStateChangedHandle, null, 0);
        ...
        private void WaitForGpsEvents()
        {
            lock (this)
            {
                ...
                IntPtr handles = Marshal.AllocHGlobal(12);
        ...
        static extern IntPtr GPSOpenDevice(IntPtr hNewPositionData, IntPtr hDeviceStateChange, string szDeviceName, int dwFlags);
