...
Module Startup
    ...
    Public Sub LocateDatabase()
        gDatabaseRoot = ConfigurationSettings.GetValue(My.Resources.AppConfigDatabaseRootFolderKey, My.Resources.AppConfigDatabaseRootFolderDefault)
        ...
        gErrorFolder = ConfigurationSettings.GetValue(My.Resources.AppConfigErrorFolderKey, My.Resources.AppConfigErrorFolderDefault)
        ...
        gDatabaseFolder = ConfigurationSettings.GetValue(My.Resources.AppConfigDataFolderKey, My.Resources.AppConfigDataFolderDefault)
        ...
        gTransactionFolder = ConfigurationSettings.GetValue(My.Resources.AppConfigPendingFolderKey, My.Resources.AppConfigPendingFolderDefault)
        ...
        gSchemaFolder = ConfigurationSettings.GetValue(My.Resources.AppConfigSchemaFolderKey, My.Resources.AppConfigSchemaFolderDefault)
        ...
        gMainDbFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigMainDbKey, My.Resources.AppConfigMainDbDefault)
        gConfigDbFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigSettingsKey, My.Resources.AppConfigSettingsDefault)
        gLocalItemsFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigLocalItemsKey, My.Resources.AppConfigLocalItemsDefault)
        gErrorLogDbFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigEventLogKey, My.Resources.AppConfigEventLogDefault)
        gGpsFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigGpsLogKey, My.Resources.AppConfigGpsLogDefault)
        gFormDefinitionFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigFormDefinitionsKey, My.Resources.AppConfigFormDefinitionsDefault)
    End Sub

    Public Sub LoadCustomTerminology()
        gTerminologyFileName = ConfigurationSettings.GetValue(My.Resources.AppConfigLanguageFileKey, My.Resources.AppConfigLanguageFileDefault)
    ...
    Public Function InitialiseWebServiceProxy(ByVal owner As Form, ByVal suppressDialog As Boolean) As Boolean
        ...
        Try
            ...
            Dim proxyString As String = ConfigurationSettings.GetValue(My.Resources.AppConfigProxyServerKey, String.Empty)
