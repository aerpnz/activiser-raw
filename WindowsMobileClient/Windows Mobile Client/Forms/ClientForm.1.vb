...
Public Class ClientForm
    ...
    Private _clientList As Generic.SortedList(Of String, ClientListItem)
...
#End If
    ...
    Private Sub LocateSelectedClientInPicker(ByVal clientSite As ClientSiteRow)
        ...
        For i As Integer = 0 To Me.ClientListComboBox.Items.Count - 1
            Dim cli As ClientListItem = TryCast(Me.ClientListComboBox.Items(i), ClientListItem)
            If cli.ClientSiteUID = clientSite.ClientSiteUID Then
    ...
    Private Sub PopulateClientList()
        Try
            _clientList = New Generic.SortedList(Of String, ClientListItem)()
            For Each csr As ClientSiteRow In gClientDataSet.ClientSite
                If csr.ClientSiteStatusRow.IsActive AndAlso Not csr.IsSiteNameNull AndAlso Not String.IsNullOrEmpty(csr.SiteName) Then
                    _clientList.Add(csr.SiteName, New ClientListItem(csr.ClientSiteUID, csr.SiteName))
                End If
            Next

            Me.ClientListComboBox.SuspendLayout()
            Me.ClientListComboBox.Items.Clear()
            For Each cli As ClientListItem In _clientList.Values
...
#Region "Toolbar Support"
    Private Sub EnableToolbars(ByVal state As Boolean)
        ...
        ConfigurationSettings.SetValue(My.Resources.AppConfigClientFormShowToolBarsKey, state)
    ...
    Private Sub EnableToolbarsOnFormLoad(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        EnableToolbars(ConfigurationSettings.GetValue(My.Resources.AppConfigClientFormShowToolBarsKey, Me.Height > Me.Width))
    End Sub
#End Region
