...
Public Class StartupForm
    ...
    Private Sub BackgroundLoader()
        Try
            ...
            gAllowNewRequests = ConfigurationSettings.GetValue(My.Resources.AppConfigAllowNewRequestsKey, True)
            gAllowRequestsForClientsOnHold = ConfigurationSettings.GetValue(My.Resources.AppConfigAllowRequestsForClientsOnHoldKey, True)

            Gps.TrackingInfoFormat = ConfigurationSettings.GetValue(My.Resources.AppConfigTrackingInfoFormatKey, My.Resources.AppConfigTrackingInfoDefaultFormat)
            ...
            ConsultantConfig.LastSync = ConfigurationSettings.GetValue(My.Resources.AppConfigForceLastSyncDateTimeKey, ConsultantConfig.LastSync)

            gSyncDays = ConfigurationSettings.GetValue(My.Resources.AppConfigSyncDaysKey, My.Resources.AppConfigSyncDaysDefault)

            Try
                gSyncStartTime = DateTime.Parse(ConfigurationSettings.GetValue(My.Resources.AppConfigSyncStartTimeKey, My.Resources.AppConfigSyncStartTimeDefault), WithoutCulture)
            Catch ex As Threading.ThreadAbortException
                ' application closing...
                Return
            Catch ex As Exception
            ...
            Try
                gSyncFinishTime = DateTime.Parse(ConfigurationSettings.GetValue(My.Resources.AppConfigSyncFinishTimeKey, My.Resources.AppConfigSyncFinishTimeDefault), WithoutCulture)
            Catch ex As Threading.ThreadAbortException
                ' application closing...
                Return
            Catch ex As Exception
            ...
            If ConfigurationSettings.GetValue("EnableTracking", False) Then Gps.StartGPS()
    ...
    Private Function GetTerminology() As Boolean
        Try
            ...
            Terminology.Load(gWebServer.GetTerminology(gDeviceIDString, gConsultantUID, Terminology.ClientKey, ConfigurationSettings.GetValue(My.Resources.AppConfigLanguageIdKey, CInt(My.Resources.AppConfigLanguageIdDefault)), DateTime.MinValue))
            Return True
        Catch ex As Exception
