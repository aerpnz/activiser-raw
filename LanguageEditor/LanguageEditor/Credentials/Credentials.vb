    ...
    Friend Function GetUrlCredentials(ByVal testUri As Uri, ByRef credentials As Net.ICredentials, ByVal owner As Form, ByVal forProxy As Boolean) As CredUIReturnCodes
        ...
        If Not forProxy Then
            If OsLevel > 500 AndAlso Not My.Settings.ForceWin2KLogon Then
                message = String.Format(My.Resources.CredentialPrompt, testUri.ToString(), My.Resources.CredentialXPHelpInfo)
            Else
                message = String.Format(My.Resources.CredentialPrompt, testUri.ToString(), My.Resources.Credential2KHelpInfo)
            End If
        Else
            If OsLevel > 500 AndAlso Not My.Settings.ForceWin2KLogon Then
                message = String.Format(My.Resources.ProxyCredentialPrompt, testUri.ToString(), My.Resources.CredentialXPHelpInfo)
            Else
                message = String.Format(My.Resources.ProxyCredentialPrompt, testUri.ToString(), My.Resources.Credential2KHelpInfo)
            End If
        End If
