...
namespace SchemaEditorWebApplication
{
	...
	public partial class activiserSchemaDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteClient(Client instance);
		...
		public activiserSchemaDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["kineticsConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public activiserSchemaDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public activiserSchemaDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public activiserSchemaDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public activiserSchemaDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Entity : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.Guid> _ParentEntityId;
		...
		private System.Nullable<System.DateTime> _EffectiveUntil;
		...
		private EntitySet<Form> _ChildForms;
    ...
    partial void OnParentEntityIdChanging(System.Nullable<System.Guid> value);
    ...
    partial void OnEffectiveUntilChanging(System.Nullable<System.DateTime> value);
    partial void OnEffectiveUntilChanged();
    ...
    partial void OnModifiedByChanged();
		...
		public Entity()
		{
			...
			this._ChildForms = new EntitySet<Form>(new Action<Form>(this.attach_ChildForms), new Action<Form>(this.detach_ChildForms));
			this._Entity1 = default(EntityRef<Entity>);
			this._AttributeType = default(EntityRef<AttributeType>);
			OnCreated();
		}
		
		[Column(Storage="_EntityId", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_ParentEntityId", DbType="UniqueIdentifier")]
		public System.Nullable<System.Guid> ParentEntityId
		{
			get
			{
		...
		[Column(Storage="_Version", DbType="Real")]
		...
		[Column(Storage="_EffectiveFrom", DbType="DateTime")]
		...
		[Column(Storage="_EffectiveUntil", DbType="DateTime")]
		public System.Nullable<System.DateTime> EffectiveUntil
		{
			get
			{
			...
			set
			{
				if ((this._EffectiveUntil != value))
				{
					this.OnEffectiveUntilChanging(value);
					this.SendPropertyChanging();
					this._EffectiveUntil = value;
					this.SendPropertyChanged("EffectiveUntil");
					this.OnEffectiveUntilChanged();
				}
			}
		}
		...
		[Association(Name="Entity_Entity", Storage="_Entities", ThisKey="EntityId", OtherKey="ParentEntityId")]
		public EntitySet<Entity> ChildEntities
		{
			get
			{
		...
		[Association(Name="Entity_Attribute", Storage="_Attributes", ThisKey="EntityId", OtherKey="EntityId")]
		...
		[Association(Name="Entity_Form", Storage="_Forms", ThisKey="EntityId", OtherKey="EntityId")]
		...
		[Association(Name="Entity_Form1", Storage="_ChildForms", ThisKey="EntityId", OtherKey="ParentEntityId")]
		public EntitySet<Form> ChildForms
		{
			get
			{
			...
			set
			{
				this._ChildForms.Assign(value);
			}
		}
		
		[Association(Name="Entity_Entity", Storage="_Entity1", ThisKey="ParentEntityId", OtherKey="EntityId", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Entity1.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ChildEntities.Remove(this);
					}
					this._Entity1.Entity = value;
					if ((value != null))
					{
						value.ChildEntities.Add(this);
						this._ParentEntityId = value.EntityId;
					}
					else
					{
						this._ParentEntityId = default(Nullable<System.Guid>);
					}
		...
		[Association(Name="AttributeType_Entity", Storage="_AttributeType", ThisKey="PrimaryKeyAttributeType", OtherKey="AttributeTypeCode", IsForeignKey=true)]
		public AttributeType PrimaryKeyAttributeTypeCode
		{
			get
			{
			...
			set
			{
							...
							|| (this._AttributeType.HasLoadedOrAssignedValue == false)))
				{
					...
					this.SendPropertyChanged("PrimaryKeyAttributeTypeCode");
				}
			}
		}
		...
		private void attach_ChildForms(Form entity)
		{
			this.SendPropertyChanging();
			entity.ParentEntity = this;
		}
		
		private void detach_ChildForms(Form entity)
		{
			this.SendPropertyChanging();
			entity.ParentEntity = null;
		}
	...
	public partial class FormField : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.Guid> _AttributeId;
    ...
    partial void OnClientMaskChanging(int value);
    partial void OnClientMaskChanged();
    partial void OnAttributeIdChanging(System.Nullable<System.Guid> value);
    ...
    partial void OnModifiedByChanged();
		...
		[Column(Storage="_FormFieldId", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_AttributeId", DbType="UniqueIdentifier")]
		...
		[Association(Name="Attribute_FormField", Storage="_Attribute", ThisKey="AttributeId", OtherKey="AttributeId", IsForeignKey=true)]
		public Attribute Attribute
		{
			...
			set
			{
							...
							|| (this._Attribute.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._AttributeId = default(Nullable<System.Guid>);
					}
    ...
    partial void OnModifiedByChanged();
		...
		[Column(Storage="_AttributeId", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Association(Name="Attribute_FormField", Storage="_FormFields", ThisKey="AttributeId", OtherKey="AttributeId")]
		...
		[Association(Name="Entity_Attribute", Storage="_Entity", ThisKey="EntityId", OtherKey="EntityId", IsForeignKey=true)]
		...
		[Association(Name="AttributeType_Attribute", Storage="_AttributeType", ThisKey="AttributeTypeCode", OtherKey="AttributeTypeCode", IsForeignKey=true)]
	...
	[Table(Name="metadata.AttributeType")]
    ...
    partial void OnSqlTypeNameChanged();
		...
		[Column(Storage="_AttributeTypeCode", AutoSync=AutoSync.Always, DbType="Int NOT NULL", IsPrimaryKey=true)]
		public int AttributeTypeCode
		{
			get
			{
		...
		[Association(Name="AttributeType_Entity", Storage="_Entities", ThisKey="AttributeTypeCode", OtherKey="PrimaryKeyAttributeType")]
		...
		[Association(Name="AttributeType_Attribute", Storage="_Attributes", ThisKey="AttributeTypeCode", OtherKey="AttributeTypeCode")]
		public EntitySet<Attribute> Attributes
		{
			get
			{
		...
		{
			this.SendPropertyChanging();
			entity.PrimaryKeyAttributeTypeCode = this;
		}
		
		private void detach_Entities(Entity entity)
		{
			this.SendPropertyChanging();
			entity.PrimaryKeyAttributeTypeCode = null;
		}
	...
	public partial class Form : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Entity> _ParentEntity;
    ...
    partial void OnEntityIdChanging(System.Nullable<System.Guid> value);
    partial void OnEntityIdChanged();
    partial void OnEntityNameChanging(string value);
    partial void OnEntityNameChanged();
    ...
    partial void OnModifiedByChanged();
		...
		public Form()
		{
			this._FormFields = new EntitySet<FormField>(new Action<FormField>(this.attach_FormFields), new Action<FormField>(this.detach_FormFields));
			this._Entity = default(EntityRef<Entity>);
			this._ParentEntity = default(EntityRef<Entity>);
			OnCreated();
		}
		
		[Column(Storage="_FormId", AutoSync=AutoSync.OnInsert, DbType="UniqueIdentifier NOT NULL", IsPrimaryKey=true, IsDbGenerated=true)]
		public System.Guid FormId
		{
			get
			{
		...
		[Column(Storage="_EntityId", DbType="UniqueIdentifier")]
		...
		[Column(Storage="_ParentEntityName", DbType="NVarChar(128) NOT NULL", CanBeNull=false)]
		public string ParentEntityName
		{
			get
			{
		...
		[Association(Name="Entity_Form", Storage="_Entity", ThisKey="EntityId", OtherKey="EntityId", IsForeignKey=true)]
		public Entity Entity
		{
			get
			{
			...
			set
			{
							...
							|| (this._Entity.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._EntityId = default(Nullable<System.Guid>);
					}
					this.SendPropertyChanged("Entity");
				}
			}
		...
		[Association(Name="Entity_Form1", Storage="_ParentEntity", ThisKey="ParentEntityId", OtherKey="EntityId", IsForeignKey=true)]
		public Entity ParentEntity
		{
			get
			{
			...
			set
			{
				Entity previousValue = this._ParentEntity.Entity;
				if (((previousValue != value) 
							|| (this._ParentEntity.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.ChildForms.Remove(this);
					}
					this._ParentEntity.Entity = value;
					if ((value != null))
					{
						value.ChildForms.Add(this);
						this._ParentEntityId = value.EntityId;
					}
					else
					{
