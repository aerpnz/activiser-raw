...
Public Class AboutForm
    ...
    Private Sub About_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Dim deviceIdText As String = Terminology.GetFormattedString(MODULENAME, "DeviceIdFormat", GetFormattedDeviceID(gDeviceID))
...
#End If
    ...
    Private Sub Close_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CloseButton.Click, Logo.Click, Me.Click
        Me.Close()
    End Sub

#Region "simulated lock - ignore keypresses."
    Private Sub AboutMessage_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles AboutMessage.KeyDown, AboutMessage.KeyUp
        e.Handled = True
    End Sub
