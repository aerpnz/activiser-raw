...
Public Class CertificatePolicy
    ...
    Public Function CheckValidationResult( _
       ...
       As Boolean Implements ICertificatePolicy.CheckValidationResult
        ...
        If ConfigurationSettings.GetValue(RES_IgnoreServerCertificateErrors, False) Then Return True

        Dim certProblem As CertificateProblemCode
        Try
            certProblem = CType(certificateProblem, CertificateProblemCode)
            If certProblem = CertificateProblemCode.CNNameMismatch AndAlso ConfigurationSettings.GetValue(RES_IgnoreServerCertificateNameMismatch, True) Then Return True
            Return False
