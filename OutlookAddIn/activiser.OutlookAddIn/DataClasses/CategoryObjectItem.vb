...
Public Class CategoryObjectItem
    Implements IComparable(Of CategoryObjectItem)
    ...
    Public Overloads Function Equals(ByVal target As CategoryObjectItem) As Boolean
    ...
    Public Shared Operator =(ByVal left As CategoryObjectItem, ByVal right As CategoryObjectItem) As Boolean
    ...
    Public Function CompareTo(ByVal other As CategoryObjectItem) As Integer Implements System.IComparable(Of CategoryObjectItem).CompareTo
        Dim result As Integer = Description.CompareTo(other.Description)
        If result = 0 Then
