...
Public Class SyncForm
    ...
    Private _autoClose As Boolean = ConfigurationSettings.GetValue(My.Resources.AppConfigAutoCloseSyncFormKey, False)
...
#Region "Button Events"
    ...
    Private Sub AutoCloseCheckBox_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles AutoCloseCheckBox.Click
        ...
        AutoCloseCheckBox.Checked = _autoClose
        ConfigurationSettings.SetValue(My.Resources.AppConfigAutoCloseSyncFormKey, _autoClose)
    End Sub
