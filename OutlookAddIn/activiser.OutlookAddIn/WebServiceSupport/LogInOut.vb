...
#End If
            If LoggedOn Then
                Terminology.Load(ConsoleData.WebService.GetTerminology(deviceId, ConsoleData.ConsoleUser.ConsultantUID, Terminology.ClientKey, My.Settings.LanguageId, DateTime.MinValue))
    ...
    Friend Function TryLogon(ByVal serverUrl As String, ByVal useIntegratedAuthentication As Boolean, ByVal username As String, ByVal password As String, ByVal linkUser As Boolean, ByVal owner As Form) As Boolean
        ...
        Try
            Dim credentials As Net.ICredentials
