...
Public Module AppConfig
    ...
    Private assemblyPath As String = [Assembly].GetCallingAssembly().GetName().CodeBase
    Private configFileUrl As String = assemblyPath + ".config"
    Private configDoc As XmlDocument
    Private htAppsettings As Collections.Generic.Dictionary(Of String, String) = Load() ' As New Collections.Generic.Dictionary(Of String, String) ' Hashtable(10)

    'Private Sub New()

    'End Sub

    Private Function Load() As Collections.Generic.Dictionary(Of String, String)
    ...
    'Public  ReadOnly Property AppSettings() As Collections.Generic.Dictionary(Of String, String)
    '    Get
    '        ' LoadConfig()
    ...
    Public Function GetSetting(ByVal key As String, ByVal defaultValue As Integer) As Integer
    ...
    Public Sub SaveSetting(ByVal key As String, ByVal value As Integer)
    ...
    Public Function GetSetting(ByVal key As String, ByVal defaultValue As Boolean) As Boolean
    ...
    Public Sub SaveSetting(ByVal key As String, ByVal value As Boolean)
    ...
    Public Function GetSetting(ByVal key As String, ByVal defaultValue As Date) As Date
    ...
    Public Sub SaveSetting(ByVal key As String, ByVal value As Date)
    ...
    Public Function GetSetting(ByVal key As String, ByVal defaultValue As Color) As Color
    ...
    Public Sub SaveSetting(ByVal key As String, ByVal value As Color)
